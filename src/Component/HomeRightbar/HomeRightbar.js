        ...
        <div className='ItemContainer'>
          <div className='ItemContainer1'>
            ...
            <div className='barchartContainer'>
              <BarChart width={200} height={120} data={data}>
                <Tooltip />
          ...
          <div className='ItemContainer1'>
            ...
            <div className='barchartContainer'>
              <BarChart width={200} height={120} data={data2}>
                <Tooltip />
          ...
          <div className='ItemContainer1'>
            ...
            <div className='barchartContainer2'>
              <LineChart width={240} height={110} data={data3}
          ...
          <div className='TasksContainer'>
            <div className='TaskChart'>
              <p className='taskContainerText'>Clientes a receber</p>
            ...
            <div className='MonthlyEarning'>
              <p className='taskContainerText'>Monthly Earning</p>
